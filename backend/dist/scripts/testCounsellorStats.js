const testCounsellorStats = async () => {
    try {
        ...
        if (analyticsData.counsellorStats && analyticsData.counsellorStats.length > 0) {
            analyticsData.counsellorStats.forEach((stat, index) => {
        ...
        if (analyticsData.recentBookings && analyticsData.recentBookings.length > 0) {
            analyticsData.recentBookings.slice(0, 3).forEach((booking, index) => {
...
testCounsellorStats();
//# sourceMappingURL=testCounsellorStats.js.map